...
export default function Hero() {
  return (
    <div id="home" className="relative bg-white overflow-hidden min-h-screen">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">
                <span className="block xl:inline">prima donna</span>{" "}
                <span className="block text-indigo-600 xl:inline">
                  your virtual opera house
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                the place where you can find additional information about the
                best operas every written, from a beginner to an advanced level.
              </p>
